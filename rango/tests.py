...
def add_page(cat, title, url, views=0, last_visit=timezone.now(), first_visit= timezone.now()):
    ...
    p.save()
    return p
class PageDateTests(TestCase):
    def test_date_right_in_pages(self):
        cat = add_cat('temp1', 1, 1)
        page = add_page(cat, "page_title", "www.baidu.com")
...
class GeneralTests(TestCase):
    def test_serving_static_files(self):
        ...
        result = finders.find('image/rango.jpg')
...
class IndexPageTests(TestCase):
    ...
    def test_rango_picture_displayed(self):
        ...
        # Chapter 4
        response = self.client.get(reverse('index'))
        self.assertIn(b'img src="/static/image/rango.jpg', response.content)
...
class AboutPageTests(TestCase):
    ...
    def test_about_contain_image(self):
        ...
        # Chapter 4
        response = self.client.get(reverse('about'))
        self.assertIn(b'img src="/static/image/', response.content)
...
class Chapter4ViewTests(TestCase):
    def test_index_contains_hello_message(self):
        ...
        response = self.client.get(reverse('index'))
        self.assertIn('Rango says', str(response.content))
    ...
    def test_about_contains_create_message(self):
        ...
        response = self.client.get(reverse('about'))
        self.assertIn('This tutorial has been put together by', str(response.content))
